import {
  ...
  StageColumn,
  getDisplayName
} from "./chunk-FXGX3QEK.js";
import {
  ReleaseActionMenu,
  ReleaseActionOptions
} from "./chunk-5WXCUNKX.js";
import {
  index
} from "./chunk-54MGRSWQ.js";
import {
...
import {
  ...
  useGetReleasesQuery
} from "./chunk-SQXK6UEN.js";
import {
  buildValidParams as buildValidParams2
} from "./chunk-AK5CFNWL.js";
import {
  getStageColorByHex
} from "./chunk-CWMCW7HV.js";
import {
  LimitsModal
} from "./chunk-DS4ETE4L.js";
import {
...
} from "./chunk-7IRXEEMH.js";
import {
  useTypedSelector
} from "./chunk-HEWIBBF7.js";
import {
...
import {
  ...
  usePersistentState,
  useSelectionState
} from "./chunk-FPZWZMTY.js";
import {
  useConfig
} from "./chunk-P7DE2XVH.js";
import {
  AssetSource,
  AssetType,
...
import {
  ...
  reducer,
  reducer2
} from "./chunk-TV2DREZT.js";
import {
  pluginId
} from "./chunk-H4GPAAVJ.js";
import {
  useDocumentActions
} from "./chunk-ZHZUP7NL.js";
import {
  buildValidParams,
  useContentManagerContext,
  useDocument,
  useDocumentLayout
} from "./chunk-IZXIYR7O.js";
import {
  renderAdmin
} from "./chunk-2R2RL5JL.js";
import {
  require_omit
...
import {
  ...
  Formik,
  useFormik
} from "./chunk-KQ2A6SNY.js";
import {
  useLicenseLimits
} from "./chunk-YCAMVSO7.js";
import {
  Table,
  useTable
} from "./chunk-ZYUEUEBK.js";
import {
  require_has
...
import {
  useAdminUsers
} from "./chunk-ZKYYTD5O.js";
import {
  useTracking
} from "./chunk-FHFNAUSQ.js";
import {
  useRBAC
} from "./chunk-QJHK35ML.js";
import {
  ForwardRef$J,
  Page,
  useAPIErrorHandler
...
var index2 = {
  register(app) {
    ...
    app.addMenuLink({
      ...
      Component: () => import("./App-6XOIFBJW.js"),
      position: 5
    });
    app.registerPlugin({
      id: pluginId,
  ...
  register(app) {
    app.createSettingSection({
    ...
    }, [
      {
        ...
        id: "settings",
        to: "email",
        Component: () => import("./Settings-YDA3VFZX.js").then((mod) => ({
...
var admin2 = {
  register(app) {
    app.addMenuLink({
      ...
      Component: () => import("./App-VYSCRRW7.js").then((mod) => ({
        default: mod.Upload
      })),
      position: 4
    });
    app.addSettingsLink("global", {
      ...
      async Component() {
        const { ProtectedSettingsPage } = await import("./SettingsPage-IGYUOY2K.js");
        return {
...
var index3 = {
  ...
  bootstrap(app) {
    ...
    app.addSettingsLink("global", {
      ...
      Component: () => import("./SettingsPage-B77JBG3H.js").then((mod) => ({
        default: mod.ProtectedSettingsPage
      })),
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled("cms-content-releases")) {
      app.addMenuLink({
        ...
        Component: () => import("./App-VDZNVUFW.js").then((mod) => ({
          default: mod.App
        })),
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { ProtectedReleasesSettingsPage } = await import("./ReleasesSettingsPage-O3ACABLO.js");
          return {
      ...
      app.widgets.register([
        {
          ...
          component: async () => {
            const { UpcomingReleasesWidget } = await import("./Widgets-CVPNRBDL.js");
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseContentReleases } = await import("./PurchaseContentReleases-FCABIEEV.js");
          return {
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled(FEATURE_ID)) {
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { Router } = await import("./router-QQREZOWA.js");
          return {
            default: Router
          };
        }
      ...
      app.widgets.register((widgets) => [
        ...widgets,
        {
          ...
          component: async () => {
            const { AssignedWidget } = await import("./Widgets-TMCI4P4Z.js");
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseReviewWorkflows } = await import("./purchase-review-workflows-WKWWN3VP.js");
          return {
...
//# sourceMappingURL=chunk-N5OKWTEU.js.map
